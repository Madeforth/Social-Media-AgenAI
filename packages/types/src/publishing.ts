 ...
 */
export type SocialAccount = Omit<TableRow<'social_accounts'>, 'token_secret_ref'>;
 ...
 */
export type PublicationJob = TableRow<'publication_jobs'>;

export type PostMetrics = Omit<TableRow<'post_metrics'>, 'raw_metrics'> & {
  raw_metrics: Record<string, unknown> | null;
};

export type NotificationType = Enums['notification_type'];

export type AppNotification = Omit<TableRow<'notifications'>, 'payload'> & {
